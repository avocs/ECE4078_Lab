...
#--------- python generateGroundTruth.py <output file name without .txt> -----------#
...
if __name__ == '__main__':
    ...
    print("Specify points on the grid, right click to undo.")
    print("Close figure when done, done = either 10 points (only ARUCOs) or 15 points (with fruits).") 
